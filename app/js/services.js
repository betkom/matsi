...
.factory('Authentication', ['$rootScope', '$cookies', function() {
        ...
        .factory('FellowService', ['$firebase', '$cookies', '$stateParams', function($firebase, $cookies, $stateParams) {
            var rootRef = new Firebase($cookies.rootRef);
