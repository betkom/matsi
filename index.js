            ...
            switch (type) {
                case 1:
                    var mailOptions = {
                        ...
                        html: "You have a pending request to be mentored, you can <a href='http://localhost:5555/myProfile'>View them here</a> <br> We hope you have a great time! <br> Team Matsi" + reason // plaintext body
                    };
                    break;
                case 2:
                    var mailOptions = {
